...
import com.experis.highfly.protocolls.ResponseMessage;
...
public class BookingController {
  ...
  //-------------------Retrieve Single Booking--------------------------------------------------------
    ...
    public ResponseEntity<ResponseMessage> createbooking(@RequestBody BookingServiceDto_1 bookingDto, UriComponentsBuilder ucBuilder) {
...
//        rm.setData(headers);
    ...
    public ResponseEntity<ResponseMessage> updateBooking(@PathVariable("id_booking") int id_booking , BookingServiceDto_1 bookingDto ) {
